...
- 機械学習・NLPを基盤に、発想から論文の雛形までは自分で作ったことがあります
- 個人開発とチーム開発（ハッカソン、サークル）の双方を経験しています
- 学業要件は卒論以外完了しており、継続的なアウトプットに集中可能です
...
英米アクセントの、話したい方面が定まってる時どのように発音したらいいかを確認できるアプリです。<br>
https://ps-coyy.vercel.app/ <br>
一生涯での価値判断の変化を、全人類で1日あたり20件ほど「購買」という形で可視化するアプリです。
